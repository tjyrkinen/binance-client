...
export default opts => {
  ...
  return {
    ...
    futuresApiReferralIfNewUser: (payload, agent) => futuresPrivCall({ path: '/v1/apiReferral/ifNewUser', data: payload, agent }),
    futuresApiReferralOverview: (payload, agent) => futuresPrivCall({ path: '/v1/apiReferral/overview', data: payload, agent }),
